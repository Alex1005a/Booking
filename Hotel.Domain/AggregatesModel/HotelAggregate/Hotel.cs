...
{
    public class HotelRoot : Entity<string>, IAggregateRoot
    {
        ...
        public HotelRoot(string name, string description, string phoneNumber, Address address, HotelOwner hotelOwner) 
        {
            Name = name;
